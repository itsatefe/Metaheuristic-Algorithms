...
namespace libxl
{
    public class Sheet
    {
        ...
        public string readStr(int row, int col)
        {
            ...
            return Book.ptrToString(xlSheetReadStr(handle, row, col, ref formatHandle));            
        }
        ...
        {
            return xlSheetWriteRichStr(handle, row, col, value.handle, IntPtr.Zero) > 0;            
        }

        public bool writeRichStr(int row, int col, RichString value, Format format)
        {
            return xlSheetWriteRichStr(handle, row, col, value.handle, format.handle) > 0;            
        }

        public double readNum(int row, int col)
        {
            IntPtr formatHandle = IntPtr.Zero;
            return xlSheetReadNum(handle, row, col, ref formatHandle);            
        }

        public double readNum(int row, int col, ref Format format)
        {
            return xlSheetReadNum(handle, row, col, ref format.handle);            
        }

        public bool writeNum(int row, int col, double value)
        {
            return xlSheetWriteNum(handle, row, col, value, IntPtr.Zero) > 0;            
        }

        public bool writeNum(int row, int col, double value, Format? format)
        {
            return xlSheetWriteNum(handle, row, col, value, (format is not null ? format.handle : IntPtr.Zero)) > 0;            
        }

        public bool readBool(int row, int col)
        {
            IntPtr formatHandle = IntPtr.Zero;
            return xlSheetReadBool(handle, row, col, ref formatHandle) > 0;            
        }

        public bool readBool(int row, int col, ref Format format)
        {
            return xlSheetReadBool(handle, row, col, ref format.handle) > 0;            
        }

        public bool writeBool(int row, int col, bool value)
        {
            return xlSheetWriteBool(handle, row, col, value ? 1 : 0, IntPtr.Zero) > 0;            
        }

        public bool writeBool(int row, int col, bool value, Format format)
        {
            return xlSheetWriteBool(handle, row, col, value ? 1 : 0, format.handle) > 0;            
        }

        public bool readBlank(int row, int col, ref Format format)
        {
            return xlSheetReadBlank(handle, row, col, ref format.handle) > 0;            
        }

        public bool writeBlank(int row, int col, Format format)
        {
            return xlSheetWriteBlank(handle, row, col, format.handle) > 0;            
        }

        public string readFormula(int row, int col)
        {
            IntPtr formatHandle = IntPtr.Zero;
            return Book.ptrToString(xlSheetReadFormula(handle, row, col, ref formatHandle));            
        }
        ...
        {
            return xlSheetWriteFormula(handle, row, col, value, IntPtr.Zero) > 0;            
        }

        public bool writeFormula(int row, int col, string value, Format format)
        {
            return xlSheetWriteFormula(handle, row, col, value, format.handle) > 0;            
        }

        public bool writeFormulaNum(int row, int col, string expr, double value)
        {
            return xlSheetWriteFormulaNum(handle, row, col, expr, value, IntPtr.Zero) > 0;
        }
        ...
        {
            return xlSheetWriteFormulaStr(handle, row, col, expr, value, IntPtr.Zero) > 0;
        }
        ...
        {
            return xlSheetWriteFormulaBool(handle, row, col, expr, value ? 1 : 0, IntPtr.Zero) > 0;
        }
        ...
        {
            return Book.ptrToString(xlSheetReadComment(handle, row, col));            
        }
        ...
        {
            return xlSheetIsDate(handle, row, col) > 0;
        }

        public bool isRichStr(int row, int col)
        {
            return xlSheetIsRichStr(handle, row, col) > 0;
        }
        ...
        {
            xlSheetWriteError(handle, row, col, (int)error, IntPtr.Zero);
        }
        ...
        {
            return xlSheetSetCol(handle, colFirst, colLast, width, IntPtr.Zero, 0) > 0;            
        }
        ...
        {
            return xlSheetSetCol(handle, colFirst, colLast, width, format.handle, 0) > 0;            
        }
        ...
        {
            return xlSheetSetCol(handle, colFirst, colLast, width, (format == null) ? IntPtr.Zero : format.handle, hidden ? 1 : 0) > 0;            
        }
        ...
        {
            return xlSheetSetRow(handle, row, height, IntPtr.Zero, 0) > 0;            
        }

        public bool setRow(int row, double height, Format format)
        {
            return xlSheetSetRow(handle, row, height, format.handle, 0) > 0;            
        }

        public bool setRow(int row, double height, Format format, bool hidden)
        {
            return xlSheetSetRow(handle, row, height, (format == null) ? (IntPtr)0 : format.handle, hidden ? 1 : 0) > 0;            
        }
        ...
        {
            return xlSheetRowHidden(handle, row) > 0;
        }

        public bool setRowHidden(int row, bool hidden)
        {
            return xlSheetSetRowHidden(handle, row, hidden ? 1 : 0) > 0;            
        }

        public bool colHidden(int col)
        {
            return xlSheetColHidden(handle, col) > 0;
        }

        public bool setColHidden(int col, bool hidden)
        {
            return xlSheetSetColHidden(handle, col, hidden ? 1 : 0) > 0;            
        }

        public bool getMerge(int row, int col, ref int rowFirst, ref int rowLast, ref int colFirst, ref int colLast)
        {
            return xlSheetGetMerge(handle, row, col, ref rowFirst, ref rowLast, ref colFirst, ref colLast) > 0;
        }

        public bool setMerge(int rowFirst, int rowLast, int colFirst, int colLast)
        {
            return xlSheetSetMerge(handle, rowFirst, rowLast, colFirst, colLast) > 0;            
        }

        public bool delMerge(int row, int col)
        {
            return xlSheetDelMerge(handle, row, col) > 0;            
        }
        ...
        {
            return xlSheetMerge(handle, index, ref rowFirst, ref rowLast, ref colFirst, ref colLast) > 0;            
        }

        public bool delMergeByIndex(int index)
        {
            return xlSheetDelMergeByIndex(handle, index) > 0;            
        }

        public int pictureSize()
        {
            return xlSheetPictureSize(handle);            
        }
        ...
        public int getPicture(int index)
        {
            ...
            return xlSheetGetPicture(handle, index, ref rowTop, ref colLeft, ref rowBottom, ref colRight,
        ...
        {
            return xlSheetRemovePictureByIndex(handle, index) > 0;            
        }
        ...
        {
            return xlSheetRemovePicture(handle, row, col) > 0;            
        }

        public int getHorPageBreak(int index)
        {
            return xlSheetGetHorPageBreak(handle, index);            
        }

        public int getHorPageBreakSize()
        {
            return xlSheetGetHorPageBreakSize(handle);            
        }

        public int getVerPageBreak(int index)
        {
            return xlSheetGetVerPageBreak(handle, index);            
        }

        public int getVerPageBreakSize()
        {
            return xlSheetGetVerPageBreakSize(handle);            
        }

        public bool setHorPageBreak(int row)
        {
            return xlSheetSetHorPageBreak(handle, row, 1) > 0;            
        }

        public bool delHorPageBreak(int row)
        {
            return xlSheetSetHorPageBreak(handle, row, 0) > 0;            
        }

        public bool setVerPageBreak(int col)
        {
            return xlSheetSetVerPageBreak(handle, col, 1) > 0;            
        }

        public bool delVerPageBreak(int col)
        {
            return xlSheetSetVerPageBreak(handle, col, 0) > 0;            
        }
        ...
        {
            return xlSheetGroupRows(handle, rowFirst, rowLast, collapsed ? 1 : 0) > 0;            
        }

        public bool groupCols(int colFirst, int colLast, bool collapsed)
        {
            return xlSheetGroupCols(handle, colFirst, colLast, collapsed ? 1 : 0) > 0;            
        }
        ...
        {
            return xlSheetInsertCol(handle, colFirst, colLast) > 0;            
        }

        public bool insertRow(int rowFirst, int rowLast)
        {
            return xlSheetInsertRow(handle, rowFirst, rowLast) > 0;            
        }

        public bool removeCol(int colFirst, int colLast)
        {
            return xlSheetRemoveCol(handle, colFirst, colLast) > 0;            
        }

        public bool removeRow(int rowFirst, int rowLast)
        {
            return xlSheetRemoveRow(handle, rowFirst, rowLast) > 0;            
        }

        public bool copyCell(int rowSrc, int colSrc, int rowDst, int colDst)
        {
            return xlSheetCopyCell(handle, rowSrc, colSrc, rowDst, colDst) > 0;            
        }
        ...
        public string header
        {
            get
            {
                return Book.ptrToString(xlSheetHeader(handle));                
            }
        ...
        public string footer
        {
            get
            {
                return Book.ptrToString(xlSheetFooter(handle));                
            }
        ...
        {
            int hidden = 0;
            return xlSheetGetNamedRange(handle, name, ref rowFirst, ref rowLast, ref colFirst, ref colLast, (int)Scope.SCOPE_UNDEFINED, ref hidden) > 0;
        }

        public bool getNamedRange(string name, ref int rowFirst, ref int rowLast, ref int colFirst, ref int colLast, int scopeId)
        {
            int hidden = 0;
            return xlSheetGetNamedRange(handle, name, ref rowFirst, ref rowLast, ref colFirst, ref colLast, scopeId, ref hidden) > 0;
        }
        ...
        {
            return xlSheetSetNamedRange(handle, name, rowFirst, rowLast, colFirst, colLast, (int)Scope.SCOPE_UNDEFINED) > 0;            
        }

        public bool setNamedRange(string name, int rowFirst, int rowLast, int colFirst, int colLast, int scopeId)
        {
            return xlSheetSetNamedRange(handle, name, rowFirst, rowLast, colFirst, colLast, scopeId) > 0;            
        }

        public bool delNamedRange(string name)
        {
            return xlSheetDelNamedRange(handle, name, (int)Scope.SCOPE_UNDEFINED) > 0;            
        }

        public bool delNamedRange(string name, int scopeId)
        {
            return xlSheetDelNamedRange(handle, name, scopeId) > 0;            
        }

        public int namedRangeSize()
        {
            return xlSheetNamedRangeSize(handle);            
        }
        ...
        public string namedRange(int index, ref int rowFirst, ref int rowLast, ref int colFirst, ref int colLast)
        {
            int scopeId = 0;
            int hidden = 0;
            return Book.ptrToString(xlSheetNamedRange(handle, index, ref rowFirst, ref rowLast, ref colFirst, ref colLast, ref scopeId, ref hidden));            
        }
        ...
        {
            return Book.ptrToString(xlSheetTable(handle, index, ref rowFirst, ref rowLast, ref colFirst, ref colLast, ref headerRowCount, ref totalsRowCount));            
        }
        ...
        {
            return Book.ptrToString(xlSheetHyperlink(handle, index, ref rowFirst, ref rowLast, ref colFirst, ref colLast));            
        }

        public bool delHyperlink(int index)
        {
            return xlSheetDelHyperlink(handle, index) > 0;            
        }
        ...
        public AutoFilter autoFilter()
        {
            ...
            if (autoFilterHandle == IntPtr.Zero)
                throw new XLError(book.errorMessage());
        ...
        public string name
        {
            get { return Book.ptrToString(xlSheetName(handle)); }
        ...
        {
            return Book.ptrToString(xlSheetRowColToAddr(handle, row, col, 1, 1));            
        }

        public string rowColToAddr(int row, int col, bool rowRelative, bool colRelative)
        {
            return Book.ptrToString(xlSheetRowColToAddr(handle, row, col, rowRelative ? 1 : 0, colRelative ? 1 : 0));            
        }
        ...
        public FormControl formControl(int index)
        {
            ...
            if (formControlHandle == IntPtr.Zero)
                throw new XLError(book.errorMessage());
        ...
        public ConditionalFormatting addConditionalFormatting()
        {
            ...
            if (conditionalFormattingHandle == IntPtr.Zero)
                throw new XLError(book.errorMessage());
        ...
        {
            return xlSheetGetActiveCell(handle, ref row, ref col) > 0;            
        }
        ...
        {
            return Book.ptrToString(xlSheetSelectionRange(handle));            
        }
